...
def main():
    ...
    parser.add_argument('-ch', '--custom-headers', type=str, help='custom header to include in all http request in header:value format')
    parser.add_argument('-p', '--proxy', type=str, help='Specify a proxy to use during the scan')
